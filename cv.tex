...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in Sep 2024}\hspace{\widthof{Last updated in Dec 2024}}
    }}}%
  }%
}%
...
%        \hspace*{0.5 cm}
    ...
    \section{Summary}
        ...
        An enthusiastic student in electronics and telecommunication engineering who strives to enhance knowledge and solve real life problems. Interested in electronics projects and research. A hockey player and a clarinetist.
        \end{changemargin}
    ...
    \section{Education}
	 ...
	 \begin{tabularx}{
                ...
                \item GPA: 4.0/4.0, Dean's list (Semester 1-2)%(\href{}{Transcript})
                %\item \textbf{Modules:} Real analysis, Sig.
	            \end{highlights}
            &
            2023 - 2027
        \end{tabularx}
...
%%%%%%%%%%%%%%% SKILLS %%%%%%%%%%%%%%%%%%
 \section{Skills}
        ...
        \item Mobile and Web: Flutter, Figma, PHP, HTML, CSS%, Flask, Javascript
        \item Tools: LTSpice, Solidworks, Unity, Matlab, Altium, Arduino  %Android Studio, Omnett++, Arduino, 
        \end{highlights}
        \par\endgroup
    ...
    \section{Projects}
       ...
       \iffalse
        % iffalse is used to comment out the project until it is public
        \vspace{0.2 cm}
        \begin{tabularx}{
            \textwidth-0.4 cm-0.13cm
        }{
            ...
            \begin{highlights}
                \item Worked on developing the frontend of the mobile app and modeled the diet-box. %Also created the circutis for the smart weighing scale for the healthy plate.
