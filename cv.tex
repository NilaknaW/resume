...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in May 2024}\hspace{\widthof{Last updated in February 2024}}
    }}}%
  }%
}%
...
%        \hspace*{0.5 cm}
    ...
    \section{Education}
	 ...
	 \begin{tabularx}{
                ...
                \item GPA: 4.0/4.0, Dean's list (Semester 1)%(\href{}{Transcript})
...
%%%%%%%%%%%%%%% SKILLS %%%%%%%%%%%%%%%%%%
 \section{Skills}
        ...
        \item Web development: PHP, HTML, CSS %, Flask, Javascript
        \item Software: Unity, Matlab%LTSpice, Android Studio, Omnett++, Arduino, 
        \end{highlights}
        \par\endgroup
